...
public class Library {
    ...
    public static String CPU0_GOV_PATH = "/sys/devices/system/cpu/cpu0/cpufreq/scaling_governor";
    public static String CPU1_GOV_PATH = "/sys/devices/system/cpu/cpu1/cpufreq/scaling_governor";
    public static String CPU2_GOV_PATH = "/sys/devices/system/cpu/cpu2/cpufreq/scaling_governor";
    public static String CPU3_GOV_PATH = "/sys/devices/system/cpu/cpu3/cpufreq/scaling_governor";
    ...
    public static String MSM_HOTPLUG_ENABLED = "/sys/module/msm_hotplug/msm_enabled";
    public static String MSM_MPDECISION_ENABLED = "/sys/module/msm_mpdecision/parameters/enabled";
    ...
    public static String MAX_CPUS_SUSP = "/sys/module/msm_hotplug/max_cpus_online_susp";
    ...
    public static String MSM_THERMAL_PATH0 = "/sys/module/msm_thermal/parameters/temp_max";
    public static String MSM_THERMAL_PATH1 = "/sys/module/msm_thermal/parameters/limit_temp";
    ...
    public static String GPU_AVAIL_FREQ_PATH0 = "/sys/devices/platform/kgsl-3d0.0/kgsl/kgsl-3d0/gpu_available_frequencies";
    public static String GPU_AVAIL_FREQ_PATH1 = "/sys/devices/fdb00000.qcom,kgsl-3d0/kgsl/kgsl-3d0/gpu_available_frequencies";
    public static String GPU_MAX_CLK_PATH0 = "/sys/devices/platform/kgsl-3d0.0/kgsl/kgsl-3d0/max_gpuclk";
    public static String GPU_MAX_CLK_PATH1 = "/sys/devices/fdb00000.qcom,kgsl-3d0/kgsl/kgsl-3d0/max_gpuclk";
    public static String GPU_POLICY_PATH0 = "/sys/devices/platform/kgsl-3d0.0/kgsl/kgsl-3d0/pwrscale/policy";
    public static String GPU_POLICY_PATH1 = "/sys/devices/fdb00000.qcom,kgsl-3d0/kgsl/kgsl-3d0/pwrscale/policy";
    public static String GPU_AVAILABLE_POLICIES = "/sys/devices/platform/kgsl-3d0.0/kgsl/kgsl-3d0/pwrscale/avail_policies";
    public static String GPU_GOV_PATH0 = "/sys/devices/platform/kgsl-3d0.0/kgsl/kgsl-3d0/pwrscale/trustzone/governor";
    public static String GPU_GOV_PATH1 = "/sys/devices/fdb00000.qcom,kgsl-3d0/kgsl/kgsl-3d0/pwrscale/trustzone/governor";
